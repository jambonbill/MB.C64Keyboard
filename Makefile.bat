...
sdcc --verbose -S -mpic16 -p18F452 --fstack --fommit-frame-pointer --optimize-goto --optimize-cmp --disable-warning 85 --obanksel=2 -pleave-reset-vector -DDEBUG_MODE=0 pic18f452.c -o _output\pic18f452.asm
if errorlevel 1 goto end_error
...
if errorlevel 1 goto end_error
echo ==========================================================================
echo Compiling sm_simple.asm
gpasm -c sm_simple.asm -o _output\sm_simple.o
if errorlevel 1 goto end_error
echo ==========================================================================
echo Compiling main.c
sdcc --verbose -S -mpic16 -p18F452 --fstack --fommit-frame-pointer --optimize-goto --optimize-cmp --disable-warning 85 --obanksel=2 -pleave-reset-vector -DDEBUG_MODE=0 main.c -o _output\main.asm
if errorlevel 1 goto end_error
